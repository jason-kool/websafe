    ...
    if (password_verify($oldPassword, $setPassword)) {
                        ...
                        if ($passwordCheck) {
                            ...
                            if ($newEmail !== "") {
                                if ($emailCheck) {
                                    ...
                                    $profileUpdated = false;
                                    $errorMsg = "Ensure that your email is properly formatted";
                                }
                            }
                        } elseif (!empty($newPassword)) {
                            $profileUpdated = false;
                            $errorMsg = "Ensure that your password contains at least 8 characters, a capital letter, and a small letter";
                        }
                    }
                } elseif (!empty($newUsername)) {
                    $profileUpdated = false;
                    $errorMsg = "Your username may only contain alphabets, numbers and underscores";
                }
            }
        }
        ...
        if (!empty($profilePicture)) {
            ...
            if (!empty($fileName) && in_array(strtolower($fileExtension), $allowedExtensions)) {
                ...
                $errorMsg = "Invalid file type. Only JPG, JPEG, and PNG files are allowed.";
            }
        }
    } else {
